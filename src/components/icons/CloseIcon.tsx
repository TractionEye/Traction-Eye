...
export const CloseIcon: React.FC<CloseIconProps> = ({ size = 35, withCircle = true, ...props }) => (
    <svg width={size} height={size} viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        {withCircle && <circle cx="17.5" cy="17.5" r="17.5" transform="rotate(180 17.5 17.5)" fill="#E1E1E1"/>}
